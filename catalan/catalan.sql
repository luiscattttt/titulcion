...
-- Tiempo de generación: 23-06-2025 a las 07:08:57
...
CREATE TABLE `tutores` (
  `id` int NOT NULL,
  `nombre_completo` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `nombre_alumno` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `tutores` (`id`, `nombre_completo`, `nombre_alumno`, `procedencia`, `area_visita`, `persona_visita`, `asunto`, `identificacion`, `hora_entrada`, `hora_salida`, `creado_en`) VALUES
(1, 'dffdsfs', 'fdssfsd', 'dfsfsf', 'sfsfffssf', 'sffsf', 'fssffs', 'fssffs', '13:00:00', '17:00:00', '2025-06-23 03:13:58');
